...
build:
	...
	@cat docs/assets/js/copyright.js js/bootstrap-transition.js js/bootstrap-alert.js js/bootstrap-button.js js/bootstrap-carousel.js js/bootstrap-collapse.js js/bootstrap-dropdown.js js/bootstrap-modal.js js/bootstrap-tooltip.js js/bootstrap-popover.js js/bootstrap-scrollspy.js js/bootstrap-tab.js js/bootstrap-typeahead.js js/bootstrap-affix.js > docs/assets/js/bootstrap.js
	@./node_modules/.bin/uglifyjs --comments -m --source-map docs/assets/js/bootstrap.min.map --source-map-url bootstrap.min.map -p 3 docs/assets/js/bootstrap.js -o docs/assets/js/bootstrap.min.js
...
bootstrap/js/*.js: js/*.js
	...
	./node_modules/.bin/uglifyjs --comments -m --source-map bootstrap/js/bootstrap.min.map --source-map-url bootstrap.min.map -p 2 bootstrap/js/bootstrap.js -o bootstrap/js/bootstrap.min.js
